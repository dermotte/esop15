 ...
 */
public class JavafxNameGenerator extends Application {
    @Override
    public void start(Stage primaryStage) throws Exception {
        ...
        TextField textPattern = new TextField("t C'Cvc Vccvc");
        ...
        buttonGenerate.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                outArea.appendText(NameGenerator.getRandomName(textPattern.getText()) + "\n");
            }
        });
